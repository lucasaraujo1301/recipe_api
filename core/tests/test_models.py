...
class ModelTests(TestCase):
    ...
    def test_create_recipe(self):
        """
        The test_create_recipe function tests that a recipe can be created and saved to the database.
        It also checks that the string representation of a recipe is equal to its title.
